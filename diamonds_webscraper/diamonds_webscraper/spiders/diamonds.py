...
class DiamondsSpider(scrapy.Spider):
    ...
    def __init__(self, page_num=1, min_carat=0.25, max_carat=0.27):
    ...
    name = 'diamonds'
    allowed_domains = ['brilliantearth.com/']
    start_urls = [
    ...
    def parse(self, response):
        rel_path = f'?shapes=Round&min_carat={self.min_carat}&max_carat={self.max_carat}&page={self.page_num}'
        full_path = start_urls + rel_path
